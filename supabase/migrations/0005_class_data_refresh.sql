...
update services set
  ...
  description = 'Classes are held on Wednesdays between 11 AM and 7 PM, one client per day, online over Zoom or in person at the studio in Mountain House, CA. Pick your class, choose one of the next two open Wednesdays and a start time, then pay online to lock in your day.',
  includes = array[
  ...
  key_features = array[
    ...
    'Private: one client per Wednesday, the day is all yours',
    'Wednesdays 11 AM to 7 PM, book one of the next two open dates',
