...
const RESPONSES = [
  ...
  { keywords: ['deposit', 'zelle', 'payment', 'pay', 'cash', 'balance'], reply: "Deposits are accepted through Zelle only:\n\n💳 Name: Ruqia Moshref\n📱 Phone: 510-491-6497\n\nInclude your name, phone number, and appointment date in the Zelle note. Send a screenshot as proof.\n\nThe remaining balance must be paid in CASH — please bring it in an envelope labeled with your name and payment amount." },
