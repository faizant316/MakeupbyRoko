  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {registrations.map(reg => {
        ...
        return (
          <div key={reg.id}>
            {/* Main card — identical layout to BookingCard */}
            <button
            ...
            >
              ...
              {/* Class names (like service in BookingCard) */}
            ...
            {isExpanded && (
              ...
              >
                ...
                {/* Delete */}
                <button
                  onClick={() => { if (window.confirm('Delete this registration? This cannot be undone.')) deleteMutation.mutate(reg.id); }}
