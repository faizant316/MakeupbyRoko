  ...
  return (
    <div>
      ...
      {selectedDate && consultationsOnDate.length > 0 && (() => {
        ...
        return (
          <div className="mb-6 rounded-xl overflow-hidden" style={{ border: `1px solid rgba(91,176,204,0.25)` }}>
            {/* Header */}
            <div className="flex items-center gap-2.5 px-4 py-3"
              style={{ background: 'rgba(91,176,204,0.07)', borderBottom: '1px solid rgba(91,176,204,0.15)' }}>
              <div className="w-5 h-5 rounded-md flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(91,176,204,0.15)' }}>
              ...
              <span className="text-[0.6rem] font-semibold px-1.5 py-0.5 rounded-full" style={{ background: 'rgba(91,176,204,0.12)', color: CONSULT_COLOR }}>
            ...
            {uniqueConsults.map((b, i) => (
              ...
              >
                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style={{ background: 'rgba(91,176,204,0.1)' }}>
