...
const CLASSES = [
  {
    ...
    title: 'Beginner Makeup Class',
    duration: '2 hours',
    price: 500,
    deposit: 250,
    description: 'Perfect for anyone who wants to learn how to do their own makeup with confidence. Focuses on creating a simple, polished everyday look. You\'ll learn proper skin preparation, product placement, brush knowledge, and easy-to-recreate techniques tailored to your features.',
    includes: [
      'Basic brush knowledge and usage',
      'Skin prep and product application',
      'Everyday makeup look',
      'Foundation and concealer shade matching',
      'Personalized product recommendations',
      'Step-by-step guidance tailored to your features',
    ],
  },
  {
    key: 'masterclass',
    title: 'Advanced Makeup Class',
    duration: '6 hours',
    price: 1400,
    deposit: 700,
    description: 'Designed for aspiring makeup artists and beauty enthusiasts looking to elevate their skills. We dive deep into full-glam techniques, advanced application methods, product layering, sculpting, and creating dramatic transformations.',
    includes: [
      'Advanced skin preparation',
      'Full-glam foundation techniques',
      'Contour and highlighting placement',
      'Eyeshadow blending and color theory',
      'Lash application techniques',
      'Creating dimension and structure',
      'Long-wear makeup techniques',
      'Professional tips from 17 years of experience',
    ],
  },
];
