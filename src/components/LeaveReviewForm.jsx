...
export default function LeaveReviewForm() {
  ...
  if (submitted) {
    return (
      <div className="flex flex-col items-center justify-center text-center py-10">
        ...
        <p className="text-[0.8rem] text-[#999] max-w-[240px] leading-relaxed">
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4 relative z-10 pointer-events-auto">
      ...
      <button
        type="submit"
        className="w-full py-3.5 rounded-lg text-[0.8rem] font-medium tracking-[0.04em] bg-[#111] text-white hover:bg-[#222] shadow-[0_4px_20px_rgba(0,0,0,0.12)] hover:shadow-[0_6px_24px_rgba(0,0,0,0.18)] active:scale-[0.98] transition-all"
      >
        Submit Review ✦
      </button>
