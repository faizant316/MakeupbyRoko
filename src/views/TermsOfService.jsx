...
const SECTIONS = [
  ...
  },
  {
    ...
    body: `A non-refundable deposit is required to secure your appointment date. Deposits are paid via Zelle to Ruqia Moshref. The remaining balance is due on the day of your appointment. Prices are subject to change without notice; confirmed bookings will honor the quoted rate.`
  },
  {
  ...
  {
    title: 'Travel Fees',
    body: `Studio appointments in Mountain House, California have no travel fee. On-location services (the artist traveling to you) are subject to a flat travel fee starting at $200 within approximately one hour of the studio. Beyond that, the booking is made as the Full Day Service, whose package price includes travel and to which no additional travel fee is charged. For destination events, all travel-related expenses (flights, hotel, per diem) are the client's responsibility.`
  },
  {
